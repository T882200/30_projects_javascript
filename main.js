...
var Confetti = function () {
    ...
    _createClass(Confetti, [{
        ...
        value: function updateConfettiParticle() {
...
function draw() {
    var offset = 100;
    var gradient = ctx.createRadialGradient(mousePos.x, mousePos.y, canvas.width, mousePos.x, mousePos.y, 0);
...
// toggle hide/view nav when mouse move
$("nav").hide();
...
// to do - fix bug when the mouse hover the nav will not disappear.
